							...
							<DialogPanel class="pointer-events-auto w-screen max-w-md">
								...
								>
									<div class="h-0 flex-1 overflow-y-auto">
										<div class="bg-gray-600 px-4 py-6 sm:px-6">
											<div class="flex items-center justify-between">
												<DialogTitle
													class="text-base font-semibold leading-6 text-yellow-400"
													>{{ title }}</DialogTitle
												>
											...
											<div class="divide-y divide-gray-200 px-4 sm:px-6">
													...
													<div>
														...
														<div class="mt-2">
															<div class="flex space-x-2">
																...
																<button
																	type="button"
																	class="relative inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border-2 border-dashed border-gray-200 bg-white text-gray-400 hover:border-gray-300 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2"
																>
															...
															<div class="relative flex items-start">
																<div class="absolute flex h-6 items-center">
																	<input
																		...
																		type="radio"
																		class="h-4 w-4 border-gray-300 text-yellow-600 focus:ring-yellow-400"
																		checked=""
																	/>
																</div>
												...
												<div class="pb-6 pt-4">
													<div class="flex text-sm">
														<a
															href="#"
															class="group inline-flex items-center font-medium text-yellow-600 hover:text-yellow-900"
														>
															<LinkIcon
									...
									<div class="flex flex-shrink-0 justify-end px-4 py-4">
										...
										<button
											type="submit"
											class="ml-4 inline-flex justify-center rounded-md bg-yellow-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-600"
										>
											Save
										</button>
									</div>
